...
def transform_path(path):
    """Processes user defined input path by interpolating (in
        ...
        Matrix representation of the path.
        
        Returns
        -------
        new_path : numpy.array, shape=(n2,2)
        New paths whose dimensions are greater than those of the original input
        path (i.e., n2 > n), as the length of the array is expanded during the
